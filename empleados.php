...
<body>
      ...
      <div class="right-section">
        <div class="search-bar">
          <input
            ...
            placeholder="Buscar..."
            id="searchInput"
            oninput="cargarEmpleados()" />
        </div>

        <script>
          // Función para obtener los empleados filtrados desde el archivo PHP y actualizar la tabla
          function cargarEmpleados() {
            const searchValue = document.getElementById("searchInput").value;

            fetch(`./get_empleados.php?search=${encodeURIComponent(searchValue)}`)
  ...
  <aside class="sidebar">
    <ul class="nav-links">
      ...
      <li>
        <a href="empleados.php" class="selected"><i class="bi bi-app"></i> Empleados</a>
      </li>
      <li>
...
function cargarEmpleados() {
    ...
    // Llamada al backend con el valor del filtro de búsqueda
    fetch(`./get_empleados.php?search=${encodeURIComponent(searchValue)}`)
      .then((response) => response.json())
      .then((data) => {
        const empleadosBody = document.getElementById("empleadosBody");
        ...
        // Agregar las filas de empleados filtrados
        data.forEach((empleado) => {
          const row = document.createElement("tr");
